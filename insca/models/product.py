    ...
    def create(self, vals):
        ...
        if vals.get('default_code'):
            if ((vals.get('default_code')[0:3] == 'A00' or vals.get('default_code')[0:3] == 'A10' or
                ...
                return self.browse()
            elif vals.get('default_code')[0:3] == 'A00' and vals.get('default_code')[11:14] == 'YYY':
                return self.browse()
        else:
            raise ValidationError(_('Todo producto debe tener referencia interna. Revise el campo.'))
